...
class Registration : Fragment(R.layout.registration) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        uslov.setOnClickListener {
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1kqaat_3wp46JMoertKEYRSa3P8T8FmAl/view?usp=sharing"))
    ...
    private fun ChangeUsername() {
        ...
        RetrofitClient.instance.changeUsername(user, "Bearer " + TokenManager.AccessToken)
            .enqueue(object :
                Callback<User> {
